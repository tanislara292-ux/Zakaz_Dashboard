...
Примечание (Zakaz Dashboard, 2025-11): API подтверждено, что те же JSON-структуры where/orderBy принимаются в query-параметрах GET-запроса. Клиент использует именно этот формат.
