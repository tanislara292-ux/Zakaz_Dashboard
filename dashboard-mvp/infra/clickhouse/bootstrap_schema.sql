...
-- Note: TTL disabled - _ver is UInt64, need DateTime column
...
-- NOTE: This section is temporarily disabled due to SQL syntax issues
-- TODO: Fix and re-enable legacy integration views
