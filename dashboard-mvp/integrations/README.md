...
|----------|----------|-------------------|--------|
| QTickets API | Продажи билетов и мероприятия | Каждые 30 минут | 🟢 Основной |
...
|--------|------------|------------|--------|
| qtickets.timer | Каждые 30 минут | Загрузка данных QTickets API | Включен |
...
1. **QTickets API → ClickHouse** (каждые 30 минут)
